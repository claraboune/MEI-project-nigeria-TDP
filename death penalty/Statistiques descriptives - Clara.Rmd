...
```{r}
death <- read_dta("~/Ensai/3A/méthode d'évaluation d'impact/MEI-project-opioids/death penalty/death.dta")
```
...
ggplot(death, aes(x = year, y = state)) +
  geom_raster(aes(fill=legal)) +
  #scale_fill_brewer(palette = "OrRd", direction = -1) +
  labs(x="Variables", y="Variables", title="insérer titre",
       subtitle = "insérer sous-titre") +
